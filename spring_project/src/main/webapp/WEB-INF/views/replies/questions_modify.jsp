	...
	<div class="col-lg-12">
		<div class ="panel panel-default">
			...
			<div class="panel-body">
				...
				<form role="form" action="/replies/questions_modify" method="post">
					<div class="row">
					...
					<button type="button" date-oper='list' onclick="location.href='/board/tip_list'" class ="btn btn-default">리스트</button>					
				</form>					
